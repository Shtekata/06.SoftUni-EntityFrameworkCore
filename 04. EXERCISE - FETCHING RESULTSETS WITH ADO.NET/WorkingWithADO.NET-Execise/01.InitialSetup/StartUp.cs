...
namespace _01.InitialSetup
{
    class StartUp
    {
        private static string connectionString = @"Server=.\SQLEXPRESS01;Database={0};Integrated Security=true;";
        ...
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                try
                {
                    ...
                    Console.WriteLine("Database created succsessfully!");
                }
                catch (Exception e)
                {
            ...
            using (connection)
            {
                try
                {
                    ...
                    Console.WriteLine("Tables created succsessfully!");
                    ...
                    Console.WriteLine("Data inserted succsessfully!");
                    Console.WriteLine($"{rowsAffected} rows affected!");
                }
                catch (Exception e)
                {
                    Console.WriteLine("There was error procesing your request!");
                    Console.WriteLine(e.Message);
                }
