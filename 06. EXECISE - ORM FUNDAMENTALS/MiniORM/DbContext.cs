...
namespace MiniORM
{
    ...
    public abstract class DbContext
    {
        ...
        private string GetTableName(Type tableTape)
        {
            var tableName = ((TableAttribute)Attribute.GetCustomAttribute(tableTape,typeof(TableAttribute))).Name;

            if (tableName == null)
            {
                tableName = dbSetProperties[tableTape].Name;
            }
